...
class Import_Export_Menu {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Import_Export_Menu_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'IMPORT_EXPORT_MENU_VERSION' ) ) {
			$this->version = IMPORT_EXPORT_MENU_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'import-export-menu';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Import_Export_Menu_Admin( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_styles' );
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts' );
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'import_export_menu_add_page' );
		$this->loader->add_action( 'wp_ajax_action-get-export', $plugin_admin, 'handle_get_export' );
		$this->loader->add_action( 'wp_ajax_nopriv_action-get-export', $plugin_admin, 'handle_get_export' );
	}
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Import_Export_Menu_Public( $this->get_plugin_name(), $this->get_version() );
	}
	 ...
	 *
	 * @since     1.0.0
	 * @return    Import_Export_Menu_Loader    Orchestrates the hooks of the plugin.
	 */
